...
// FIX: updated imports to use @/ alias
...
// FIX: define the meta shape as a named type so TYPE_META and DEFAULT_META share it
type MetaShape = {
  color: string
  dim: string
  border: string
...
// ─────────────────────────────────────────────────────────────────────────────
// FIX: DEFAULT_META moved above TYPE_META so typeof DEFAULT_META is available
// ─────────────────────────────────────────────────────────────────────────────
const DEFAULT_META: MetaShape = {
  color:  C.sky,
  dim:    C.skyDim,
...
// FIX: typed as Record<string, MetaShape> so values are compatible with DEFAULT_META
// ─────────────────────────────────────────────────────────────────────────────
const TYPE_META: Record<string, MetaShape> = {
  past_question: {
    color:  C.lavender,
    dim:    C.lavDim,
...
export default function CoursesScreen() {
  ...
  useEffect(() => {
    ...
    // FIX: explicit type annotation on session to resolve implicit any error
