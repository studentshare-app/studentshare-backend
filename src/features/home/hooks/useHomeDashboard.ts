...
export function useHomeDashboard({
  ...
  return {
    ...
    stats: {
      ...
      globalRank:   effectiveData?.stats?.global_rank  ?? null,
      totalPoints:  effectiveData?.stats?.total_points ?? 0,
      sharedMaterialsCount: effectiveData?.stats?.shared_materials_count ?? 0,
    },
